...
def list_handlers(update, context):
    ...
    filter_list += "Total Filters:" + len(totalf) 
...
def addnew_filter(update, chat_id, keyword, text, file_type, file_id, buttons):
    ...
    if len(totalfilt) >= 700:  # Idk why i made this like function....
        msg.reply_text("This group has reached its max filters limit of 700.")
        return False
    else:
